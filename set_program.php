...
<body onload="get_page_program('get_program')" >
	<div align="center">
		<div id="main">
			<?php
					...
					<td class="left_content" valign="top">
						<hr width="80%" color="#c3c3c3" size="1" />
							<font color="#006F9A" size="5">
								...
								Setting the school schedule by hours
							</font>
						<hr width="80%" color="#c3c3c3" size="1" />	
						<br /> 
						<div id="sort">
							<div align="center">
								Select a day:
								<select id="day" name="day" onchange="get_program(this.value, 'get_program');location.href='#'+convert_day(this.value)" >
									<option value="---" >---</option>
